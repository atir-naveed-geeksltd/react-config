const defaultConfig = {
    ...
    roots: ['<rootDir>/src/'],
    setupFilesAfterEnv: ['<rootDir>/node_modules/@atir-naveed-geeksltd/jest-config-react/setupAfterEnv.js'],
    testEnvironment: 'jsdom',
    testMatch: ['**/*.(spec|test).(ts|tsx)'],
    verbose: true,
    moduleNameMapper: {
        '\\.(css|less|xsl)$': '<rootDir>/node_modules/@atir-naveed-geeksltd/jest-config-react/styleMock.js',
